...
% =====================================================================
% TARGET JOURNAL: Biomedical Microdevices (Springer Nature).
% REFERENCE STYLE: sn-basic (Springer Nature basic AUTHOR-YEAR style),
%   which is the style Biomedical Microdevices uses. In-text citations are
...
% ---------------------------------------------------------------------
% GRAPHICAL ABSTRACT REMINDER:
%   Biomedical Microdevices requires a SEPARATE Graphical Abstract figure
%   to be supplied at first submission. It must be a standalone image file
%   (not embedded in the main text), minimum 300 dpi, with an aspect ratio
%   of 11:6. Prepare and upload it as a distinct submission item; it is not
%   produced by this .tex file.
% ---------------------------------------------------------------------
...
% ORCID: Biomedical Microdevices requests the full 16-digit ORCID for each
...
\keywords{microfluidics, Hall effect, magnetic bead detection, biosensor, analytical model, design optimization}
