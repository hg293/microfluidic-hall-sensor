%% =====================================================================
%% MDPI Biosensors research article — manuscript body
%%
%% HOW TO COMPILE
%% -------------------------------------------------------------------
%% This file targets the MDPI journal "Biosensors" via the journal token
%% in \documentclass below. The official MDPI template bundle (the
%% Definitions/ folder with mdpi.cls, mdpi.bst, and the logos) sits next
%% to this file in paper/, so it compiles in place. Steps:
%%   1. Keep the Definitions/ folder, the bibliography references.bib, and
%%      the figures/ folder alongside this file (all already in paper/).
%%      On Overleaf, either open the official MDPI template and choose the
%%      journal "Biosensors", or upload this file together with the bundled
%%      Definitions/ folder.
%%   2. Compile with pdfLaTeX -> BibTeX -> pdfLaTeX -> pdfLaTeX.
%%
%% RECLASSIFICATION NOTE
%% -------------------------------------------------------------------
%% The manuscript body is journal-agnostic. To retarget to another MDPI
%% journal (e.g. "micromachines"), change only the journal token in
%% \documentclass below. A Micromachines-targeted copy of the same paper
%% is in micromachines.tex.
%% =====================================================================

\documentclass[biosensors,article,submit,pdftex,moreauthors]{Definitions/mdpi}
